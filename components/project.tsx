...
export default function Project({
  ...
  return (
    ...
    >
      <section className="hover:border-accent-teal/20 dark:hover:border-accent-teal/15 relative max-w-2xl overflow-hidden rounded-lg border border-black/5 bg-gray-100 transition hover:bg-gray-200 sm:h-80 sm:pr-8 sm:group-even:pl-8 dark:border-white/5 dark:bg-white/10 dark:text-white dark:hover:bg-white/20">
